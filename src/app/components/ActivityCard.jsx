    ...
    >
      ...
      <div className="p-6 pt-0">
        <Link
          ...
          className="select-none  rounded-lg py-3 px-6 text-center align-middle font-sans text-xs font-medium uppercase text-white  transition-all hover:shadow-lg border border-solid border-white/40 hover:border-white/80  focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
          href={linkToCard}
        >
          Read More
        </Link>
